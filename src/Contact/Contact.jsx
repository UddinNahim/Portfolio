        ...
        <div className='py-8 lg:py-16 mx-auto max-w-screen-md'>
            ...
            <form action="#" className='space-y-8'>
                <div>
                    ...
                    <input 
                    type='email' id='email' className='shadow-sm bg-gray-300 font-bold border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5'
                ...
                <div className='sm:col-span-2 '>
                    ...
                    <textarea  rows="6"
                    type='message' id='message' className='shadow-sm bg-gray-300 font-bold border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5'
