        ...
        via-yellow-500 to-red-400 absolute rounded-full transform rotate-12 -top-20 shadow-[0_0_40px_rgb(255, 165, 0, 0.7)]'
            ...
            className='text-white body-font z-10'>
                <div className='container mx-auto flex px-5 md:flex-row flex-col items-center'>
                    ...
                    '>
                        <a href={CV} download>
                            <button className='inline-flex text-white bg-orange-500 border-0 py-2  px-6 focus:outline-none hover:bg-orange-600 hover:shadow-[0_0_40px_rgb(255,165,0,0,0.7)] rounded-full text-lg '>
                    ...
                    <img src={img}  alt="hero"  className='object-cover-center rounded-full w-80 h-80' />
