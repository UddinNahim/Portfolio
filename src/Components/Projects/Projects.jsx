...
export default function Projects() {
    ...
    const settings = {
        dots: true,
        infinite: true, // Corrected typo 'Infinity' to 'infinite'
        slidesToShow: 3, // Default number of slides to show
        slidesToScroll: 1,
        arrows: true,
        responsive: [ // Array of breakpoints for responsiveness
            {
            ...
            <Slider {...settings}>
                {
                    listProjects.map((project) =>{
                        ...
                        <div className='h-full border-2 border-x-orange-400 shadow-[0_0_15px_rgba(255,165,0,0,0.7)] border-opacity-60 rounded-lg overflow-hidden'>
