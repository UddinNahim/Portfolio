...
export default function Language() {
    const languages = [
        ...
        {code:'Bn' , name:'Bangla',level:'Native'} 
    ]
        
  return (
    <section data-aos='fade-up' data-aos-delay='400' id='language' className='flex flex-wrap md:flex-nowrap items-center justify-center gap-10 md:gap-20 h-[300p] text-blue-950 mt-11 '>
